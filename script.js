...
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "BTech Computer Science Engineering Student at NMIMS",
      "#ffffff"
    )}
${this.wrapWithColor("│", "#ff8c00")} ${this.wrapWithColor(
      "University with a passion for AI.",
      "#ffffff"
    )}
${this.wrapWithColor(
  "└─────────────────────────────────────────────────────────┘",
...
${this.wrapWithColor(
  "   Building scalable and intelligent software solutions using",
  "#ffffff"
)}
${this.wrapWithColor("   Python, TensorFlow, and Data Analytics", "#ff8c00")}
...
<span style="color: #00ffff;">Sobus Insight Forum | Event Management Member</span>
${this.wrapWithColor(
  "Aug 2024 - Jul 2025 | India",
  "#ffffff"
)}
${this.wrapWithColor(
  "Fostering innovation and student engagement",
  "#98fb98"
)}

• ${this.wrapWithColor("Events Organizer", "#ffa07a")} - ${this.wrapWithColor(
      "Organized events, panel discussions, and interactive sessions.",
      "#ffffff"
    )}

<span style="color: #00ffff;">Seva Ek Nai Pahal | Elder Care Volunteer</span>
${this.wrapWithColor(
  "June 2024 | India",
  "#ffffff"
)}

• ${this.wrapWithColor("Volunteer Work", "#ffa07a")} - ${this.wrapWithColor(
      "Volunteered at an NGO supporting senior citizens.",
      "#ffffff"
    )}
• ${this.wrapWithColor("Support", "#ffa07a")} - ${this.wrapWithColor(
      "Assisted with daily routines, organized activities, provided emotional support.",
      "#ffffff"
    )}`;
...
<span style="color: #00ffff;">Frameworks</span>
• ${this.wrapWithColor("TensorFlow", "#ffffff")}
• ${this.wrapWithColor("XGBoost", "#ffffff")}
• ${this.wrapWithColor("LangChain", "#ffffff")}
• ${this.wrapWithColor("Pandas", "#ffffff")}
• ${this.wrapWithColor("NumPy", "#ffffff")}
• ${this.wrapWithColor("Matplotlib", "#ffffff")}

<span style="color: #00ffff;">Tools</span>
• ${this.wrapWithColor("Excel", "#ffffff")}
• ${this.wrapWithColor("Power BI", "#ffffff")}
• ${this.wrapWithColor("Tableau", "#ffffff")}
• ${this.wrapWithColor("VS Code", "#ffffff")}
• ${this.wrapWithColor("Jupyter Notebook", "#ffffff")}

<span style="color: #00ffff;">Coursework</span>
• ${this.wrapWithColor("DSA", "#ffffff")}
• ${this.wrapWithColor("DBMS", "#ffffff")}
• ${this.wrapWithColor("Operating Systems", "#ffffff")}

<span style="color: #00ffff;">Soft Skills</span>
• ${this.wrapWithColor("Leadership", "#ffffff")}
• ${this.wrapWithColor("Analytical Problem Solving", "#ffffff")}
• ${this.wrapWithColor("Teamwork", "#ffffff")}
• ${this.wrapWithColor("People Management", "#ffffff")}
• ${this.wrapWithColor("Event Planning", "#ffffff")}`;
...
${this.wrapWithColor("✉", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="mailto:[add your email here]" style="color: #ffffff; text-decoration: none;">[add your email here]</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("🌐", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="https://adityayashovardhan.me" target="_blank" style="color: #ffffff; text-decoration: none;">adityayashovardhan.me</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("⚡", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="[add your GitHub link here]" target="_blank" style="color: #ffffff; text-decoration: none;">github.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("💼", "#ff8c00")}  ${this.wrapWithColor(
      ...
      '<a href="[add your LinkedIn link here]" target="_blank" style="color: #ffffff; text-decoration: none;">linkedin.com</a>',
      "#ffffff"
    )}
...
${this.wrapWithColor("╰────────────────────────────────────────╯", "#ff8c00")}`;
    ...
    this.projects = [
      {
        ...
        description: "Multi-model stock price prediction system using Bi-LSTM-GRU, Random Forest, and XGBoost with 30+ financial indicators.",
        image: "image/social-cover.png",
        technologies: ["Python", "Bi-LSTM-GRU", "Random Forest", "XGBoost"],
        demo: "#",
        repo: "[add your GitHub link here]",
      },
      {
        title: "AI-Powered Music Genre Classifier",
        description: "CNN-based deep learning model classifying music into 10 genres from raw audio with 88.55% accuracy.",
        image: "image/social-cover.png",
        technologies: ["Python", "TensorFlow", "CNN", "Librosa", "GTZAN"],
        demo: "#",
        repo: "[add your GitHub link here]",
      },
      {
        title: "Multi-Agent AI Research System",
        description: "Multi-agent research automation system using LangChain, Google Gemini, and Tavily.",
        image: "image/social-cover.png",
        technologies: ["Python", "LangChain", "Google Gemini", "Tavily", "Streamlit"],
        demo: "#",
        repo: "[add your GitHub link here]",
      }
    ];
  ...
  generateLinkedInCover(outputElement) {
    ...
    terminalTitle.textContent = "aditya@yashovardhan: ~/interactive-resume";
...
╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝ ╚═════╝ `;
    ...
    role.textContent = "BTech Computer Science Engineering Student";
    ...
    url.textContent = "adityayashovardhan.me";
